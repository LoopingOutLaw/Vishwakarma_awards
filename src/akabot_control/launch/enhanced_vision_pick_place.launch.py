#!/usr/bin/env python3
"""
Launch file for enhanced vision-based pick and place
"""
...
def generate_launch_description():
    ...
    # Launch Gazebo with balls world
    ...
    # Enhanced vision pick and place controller
    enhanced_controller = TimerAction(
        period=25.0,
        actions=[
            Node(
                package='akabot_control',
                executable='enhanced_vision_pick_place',
                name='enhanced_vision_pick_place',
                output='screen',
                parameters=[
                    {'use_sim_time': True}
                ]
